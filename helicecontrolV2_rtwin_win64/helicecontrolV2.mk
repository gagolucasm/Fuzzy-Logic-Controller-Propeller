...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2014b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := helicecontrolV2
MODULES              := helicecontrolV2_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := helicecontrolV2.mk
...
RTWINDIR             := C:/PROGRA~1/MATLAB/R2014b/toolbox/rtw/targets/rtwin
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := helicecontrolV2lib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := helicecontrolV2_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/Lucas/Dropbox/helicecontrolV2_rtwin_win64;C:/Users/Lucas/Dropbox;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/dsp/include;$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src;$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include;$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
